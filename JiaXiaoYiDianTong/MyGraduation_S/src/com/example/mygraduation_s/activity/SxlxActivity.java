...
public class SxlxActivity extends Activity implements OnClickListener,
	...
	public void onClick(View v) {
		...
		case R.id.btn_previous:
			if (currentQuestionIndex > 0) {
				...
				Toast.makeText(SxlxActivity.this, "已经到头啦!", Toast.LENGTH_SHORT)
						.show();
			}
			break;
		case R.id.btn_collect:
			if (!hasCollected) {
				...
				Toast.makeText(SxlxActivity.this, "收藏成功", Toast.LENGTH_SHORT)
						.show();
				...
				Toast.makeText(SxlxActivity.this, "已取消收藏", Toast.LENGTH_SHORT)
						.show();
		...
		case R.id.btn_check:
			...
			if (option == 0) {
				Toast.makeText(SxlxActivity.this, "您还没有做出选择", Toast.LENGTH_LONG)
						.show();
			} else if (option == question.getAnswer()) {
				Toast.makeText(SxlxActivity.this, "好厉害！回答正确！",
				...
				Toast.makeText(SxlxActivity.this, "回答错误，正确答案为" + showAnswer,
						Toast.LENGTH_LONG).show();
			}
			break;
		case R.id.btn_next:
			if (currentQuestionIndex < sizeOfList - 1) {
				...
				Toast.makeText(SxlxActivity.this, "这已经是最后一题啦！",
